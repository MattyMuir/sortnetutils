...
int main()
{
	Network network = ParseNetwork(R"(
		...
		[(1,3),(2,4),(5,6),(7,8),(9,13),(11,15),(12,16),(14,18),(19,20),(21,22),(23,25),(24,26)]
		[(2,7),(4,8),(6,10),(9,11),(12,14),(13,15),(16,18),(17,21),(19,23),(20,25)]
		[(2,3),(4,7),(5,6),(8,9),(10,12),(11,16),(13,14),(15,17),(18,19),(20,23),(21,22),(24,25)]
		[(4,5),(6,7),(8,10),(9,12),(11,13),(14,16),(15,18),(17,19),(20,21),(22,23)]
...
#if 0
	auto outputs = GetOutputs(network, 28);
#else
	FactoredOutputSet outputs{ network, 28 };
#endif
	...
	std::println("Num outputs: {}", outputs.Size());
}